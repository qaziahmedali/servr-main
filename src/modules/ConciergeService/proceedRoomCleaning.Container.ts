...
import ProceedRoomCleaningService from './proceedRoomCleaning';
...
export interface IProceedRoomCleaningServiceReduxProps
    extends ReturnType<typeof mapStateToProps>,
        ReturnType<typeof mapDispatchToProps> {}

export default connect(mapStateToProps, mapDispatchToProps)(ProceedRoomCleaningService);
