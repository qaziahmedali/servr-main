...
import { IProceedRoomCleaningServiceReduxProps } from './proceedRoomCleaning.Container';
...
interface IProceedRoomCleaningServiceProps extends IProceedRoomCleaningServiceReduxProps {
    componentId: string;
}

interface IProceedRoomCleaningServiceState {
    loadingGet: boolean;
    serviceItems: Array;
    selected: number;
    loading: boolean;
...
class ProceedRoomCleaningService extends React.Component<
    IProceedRoomCleaningServiceProps,
    IProceedRoomCleaningServiceState
> {
    ...
    constructor(props: IProceedRoomCleaningServiceProps) {
        super(props);
        this.state = {
            loadingGet: false,
            serviceItems: [
...
export default ProceedRoomCleaningService;
