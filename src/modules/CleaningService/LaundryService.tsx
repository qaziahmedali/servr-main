...
// import { IRequestItemsReduxProps } from '../CheckIn/AdditionalService.Container';
import { ILaundryService } from '../../types/conciergeService';
...
// interface ILaundryServiceProps extends ILaundryServiceReduxProps {
//     componentId: string;
//     LaundaryServices: [];
//     onAdditionalServiceBack: any;
//     items: any;
...
class LaundryService extends React.Component<ILaundryServiceProps, ILaundryServiceState> {
    ...
    _handleOrderRoomService({
        ...
        const laundry_services = this.state.items;
        console.log('laundry_services', laundry_services, this.state.item);
        ...
        return new Promise((resolve, reject) => {
            const item = {
                ...
                type: paymentType,
                reservation_date_time: `${format(date, 'YYYY-MM-DD HH:mm:ss')}`,
    ...
    proceed_to_card(charges) {
        ...
        console.log('vatt', this.props.hotelTaxes.data);
        // var array = this.props.hotelTaxes.data.laundry_services;
        ...
        if (this.state.items?.length > 0) {
            Navigation.push(
                ...
                PaymentDetailScreen({
                    ...
                    cvv: this.state.cvv,
                    taxes:
                        this.props.hotelTaxes.data.laundry_services == undefined
                            ? null
                            : this.props.hotelTaxes?.data?.laundry_services?.[0],
                }),
            );
        } else {
            this.setState({
    ...
    async componentDidMount() {
        ...
        this.props.getLaundryServices(this.props.code);
        console.log('taxesDattttttttttttttttttt', this.props.hotelTaxes);
    }
    ...
    _handleModalNoteServiceRequestItem(item: ILaundryService | null, closeModal?: boolean) {
        return () => {
            Keyboard.dismiss();
    ...
    _addTotalService(item: ILaundryService) {
    ...
    _substractTotalService(item: ILaundryService) {
    ...
    _keyExtractor(item: ILaundryService) {
    ...
    _renderItem({ item, index }: { item: ILaundryService }) {
        const selected = find(this.state.items, { service_id: item.id });
            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding" enabled={Platform.OS === 'ios'}>
                    ...
                    >
                        ...
                        <ScrollView showsVerticalScrollIndicator={false}>
                            ...
                            <FlatList
                                ...
                                data={this.props.LaundaryServices}
                ...
                >
                    <ProcessComplete
                        ...
                        processDescription={'Your request for Laundry services has been requested'}
