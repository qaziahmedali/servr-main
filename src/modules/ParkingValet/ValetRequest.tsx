...
import { IValetRequestReduxProps } from './ValetRequest.Container';
...
import { mainmenu, valetparkingcomplete } from '../../utils/navigationControl';
...
interface IValetRequestProps extends IValetRequestReduxProps {
    componentId: string;
    added: boolean;
    item: object;
}

interface IValetRequestState {
    isLoading: boolean;
...
class ValetRequest extends React.Component<IValetRequestProps, ISelfValetRequestState> {
                        ...
                        <RootContainer>
                            ...
                            >
                                <Navbar
                                    ...
                                    title={this.props.selectedLanguage.valet_request}
                                />
                            </View>
                            <ScrollView
                                style={{
                            ...
                            >
                                ...
                                <View style={{ paddingHorizontal: wp(1) }}>
                                    {/* <ButtonPrimary
                                        ...
                                        text={this.props.selectedLanguage.valet_request}
