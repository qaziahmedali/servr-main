...
import SelfParking from './SelfParking';
...
import ValetRequest from './ValetRequest';
...
export interface IValetRequestReduxProps
    extends ReturnType<typeof mapStateToProps>,
        ReturnType<typeof mapDispatchToProps> {}

export default connect(mapStateToProps, mapDispatchToProps)(ValetRequest);
